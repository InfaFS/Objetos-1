...
public class DistribuidoraTest {
	...
	public void setUp() {
		...
		alto = new Consumo(LocalDate.of(2021, 6, 8), 5000.0, 2500.0);
		bajo = new Consumo(LocalDate.of(2021, 6, 10), 300.0, 300.0);
		medio = new Consumo(LocalDate.of(2021, 6, 15), 100.0, 800.0);
	...
	public void testConsumoTotalDeLaRed() {
		...
		Consumo otro = new Consumo(LocalDate.of(2021, 7, 15), 100.0, 800.0);
