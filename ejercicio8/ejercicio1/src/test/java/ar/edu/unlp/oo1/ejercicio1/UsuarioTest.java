...
public class UsuarioTest {
	...
	public void setup() {
		...
		this.consumoEnero = new Consumo(LocalDate.of(2021, 1, 1) , 800.0, 100.0);
		this.consumoFebrero = new Consumo(LocalDate.of(2021, 2, 1) , 860.0, 30.0);
		this.consumoMarzo = new Consumo(LocalDate.of(2021, 3, 1) , 820.0, 10.0);
		this.consumoAbril = new Consumo(LocalDate.of(2021, 4, 1) , 200.0, 150.0);
